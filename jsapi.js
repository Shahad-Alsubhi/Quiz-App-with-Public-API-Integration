...
<button type="submit" class="submit">submit</button>
   ...
   `;
      ...
      function displayQuestion() {
        ...
        let options = questions[currentIndex]["incorrect_answers"].concat(
          questions[currentIndex]["correct_answer"]
        );
        options.sort();
        optionsTag.forEach((tag) => {
          questions[currentIndex].userOption == options[i]
      ...
      submitbutton.onclick = () => {
        ...
        questions.forEach((opj, index) => {
          console.log(opj.userOption == opj.correct_answer);

          if (opj.userOption == opj.correct_answer) {
            i = i + 1;
          }
          ...
          answerDiv.innerHTML += ` <h5><i class="fa-regular fa-circle-check" style="color: #c4eb9b;"></i>  ${opj.correct_answer}</h5>
`;
          if (opj.userOption != opj.correct_answer)
          ...
          questionsdiv.append(answerDiv);
        });
        scorediv.append(questionsdiv);
